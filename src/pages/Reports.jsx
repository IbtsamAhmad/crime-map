...
import { Card, Row, Col, Progress, Spin, Button , Divider} from "antd";
    ...
    (async () => {
      try {
        ...
        if (crimeTypeResponse) {
          ...
          const labels = Object.keys(crimeData).map((label) =>
    ...
    <div className="reports-container">
      <Spin spinning={loading}>
       ...
       User Crime Details
        ...
        <Link to="/user-crimes">
        <Button type="primary">Crimes</Button>
        </Link>
        <Divider/>
        <h1 style={{ marginTop: "3rem" }}>
          Areas with most criminal activities
        </h1>
